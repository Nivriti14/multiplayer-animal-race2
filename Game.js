class Game {
  ...
  start() {
    ...
    horse = createSprite(width / 2 + 100, height - 100);
    horse.addAnimation("horse", horse_img);
    horse.scale = 0.07;

    monkey = createSprite(width / 2 - 50, height - 100);
    ...
    players = [horse_img, lion_img, monkey_img, tiger_img];
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      image( 0, -height * 5, width, height * 6);
